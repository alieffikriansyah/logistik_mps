...
<head>
    ...
    <title><?= $title; ?> | LOGISTIK MPS</title>
   ...
   <!-- jQuery (PASTIKAN INI DITAMBAHKAN SEBELUM SELECT2) -->
...
<ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="">
        <div class="sidebar-brand-icon">
           <img src="<?= base_url('assets/uploads/ias.png'); ?>" style="width:100px; height:auto;">
        </div>
        <div class="sidebar-brand-text mx-2">LOGISTIK OM ELEKTRIKAL</div>
    </a>
    ...
    <?php if (userdata('role') == 'admin') : ?>
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?= base_url('material_request'); ?>">
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?= base_url('kebutuhan'); ?>">
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Powered BY &copy; LOGISTIK MPS</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
...
$(document).ready(function() {
    ...
    $('.select2-barang').select2({
        ...
        allowClear: true,
        width: '100%',
        dropdownParent: $('#barang_id').parent(),
        language: {
            noResults: function() {
    ...
    $('#barang_id').on('change', function() {
        ...
        $('#stok').val(stok);
        $('#satuan').text('Satuan'); // static label
        calculateTotalStok();
    });

    // Event ketika jumlah masuk diubah
    $('#jumlah_masuk').on('input', function() {
        calculateTotalStokMasuk();
    });

     // Hitung total stok saat jumlah keluar diinput
    $('#jumlah_keluar').on('input', function() {
        calculateTotalStokKeluar();
    });

    function calculateTotalStokMasuk() {
        var stok = parseInt($('#stok').val()) || 0;
        var jumlahMasuk = parseInt($('#jumlah_masuk').val()) || 0;
        var totalStok = stok + jumlahMasuk;
        $('#total_stok').val(totalStok);
    }
    function calculateTotalStoKeluar() {
        var stok = parseInt($('#stok').val()) || 0;
        var jumlahKeluar = parseInt($('#jumlah_keluar').val()) || 0;
        var total = stok - jumlahKeluar;
        $('#total_stok').val(total >= 0 ? total : 0);  // Jangan sampai negatif
    }

    // Set placeholder saat dropdown dibuka
    $('.select2-barang, .select2-supplier').on('select2:open', function() {
