    ...
    <div class="col-md-12">
        <div class="card shadow mb-4">
            <div class="card-header bg-primary py-3">
                <h6 class="m-0 font-weight-bold text-white text-center">10 Material Request Terbaru</h6>
            </div>
            <div class="table-responsive">
                <table class="table mb-0 table-sm table-striped text-center">
                    ...
                    <tbody>
                        <?php if (!empty($material_request)) : ?>
                            <?php foreach ($material_request as $mr) : ?>
                                <tr>
                                    <td><strong><?= date('d-m-Y', strtotime($mr['tanggal'])); ?></strong></td>
                                    <td><?= $mr['nama_barang']; ?></td>
                                    <td><span class="badge badge-primary"><?= $mr['stok']; ?> <?= $mr['nama_satuan']; ?></span></td>
                                    <td><?= $mr['nama'] ?? '-'; ?></td>
                                    <td><?= $mr['role'] ?? '-'; ?></td>
                        ...
                        <?php else : ?>
                            <tr>
                                <td colspan="4" class="text-center">Tidak ada material request</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
