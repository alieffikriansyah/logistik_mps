            ...
            <div class="card-body pb-2">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="custom-control custom-radio">
                            <input <?= $user['role'] == 'hvmv' ? 'checked' : ''; ?> <?= set_radio('role', 'hvmv'); ?> value="hvmv" type="radio" id="hvmv" name="role" class="custom-control-input">
                            <label class="custom-control-label" for="hvmv">HVMV</label>
                        </div>
                        <div class="custom-control custom-radio">
                             <input <?= $user['role'] == 'ps1' ? 'checked' : ''; ?> <?= set_radio('role', 'ps1'); ?> value="ps1" type="radio" id="ps1" name="role" class="custom-control-input">
                            
                            <label class="custom-control-label" for="ps1">PS 1</label>
                        </div>
                        <div class="custom-control custom-radio">
                             <input <?= $user['role'] == 'ps2' ? 'checked' : ''; ?> <?= set_radio('role', 'ps2'); ?> value="ps2" type="radio" id="ps2" name="role" class="custom-control-input">
                            
                            <label class="custom-control-label" for="ps2">PS 2</label>
                        </div>
                        <div class="custom-control custom-radio">
                             <input <?= $user['role'] == 'ps3' ? 'checked' : ''; ?> <?= set_radio('role', 'ps3'); ?> value="ps3" type="radio" id="ps3" name="role" class="custom-control-input">
                            
                            <label class="custom-control-label" for="ps3">PS 3</label>
                        </div>
                        <div class="custom-control custom-radio">
                             <input <?= $user['role'] == 'ep' ? 'checked' : ''; ?> <?= set_radio('role', 'ep'); ?> value="ep" type="radio" id="ep" name="role" class="custom-control-input">
                            
                            <label class="custom-control-label" for="ep">EP</label>
                        </div>
                        <div class="custom-control custom-radio">
                             <input <?= $user['role'] == 'en' ? 'checked' : ''; ?> <?= set_radio('role', 'en'); ?> value="en" type="radio" id="en" name="role" class="custom-control-input">
                            
                            <label class="custom-control-label" for="en">EN</label>
                        </div>
                        <div class="custom-control custom-radio">
                             <input <?= $user['role'] == 'nva' ? 'checked' : ''; ?> <?= set_radio('role', 'nva'); ?> value="nva" type="radio" id="nva" name="role" class="custom-control-input">
                            
                            <label class="custom-control-label" for="nva">NVA</label>
                        </div>
                        <div class="custom-control custom-radio">
                             <input <?= $user['role'] == 'sva' ? 'checked' : ''; ?> <?= set_radio('role', 'sva'); ?> value="sva" type="radio" id="sva" name="role" class="custom-control-input">
                            
                            <label class="custom-control-label" for="sva">SVA</label>
                        </div>
                        <div class="custom-control custom-radio">
                             <input <?= $user['role'] == 'eu' ? 'checked' : ''; ?> <?= set_radio('role', 'eu'); ?> value="eu" type="radio" id="eu" name="role" class="custom-control-input">
                            
                            <label class="custom-control-label" for="eu">EU</label>
                        </div>
                        <div class="custom-control custom-radio">
                             <input <?= $user['role'] == 'ups' ? 'checked' : ''; ?> <?= set_radio('role', 'ups'); ?> value="ups" type="radio" id="ups" name="role" class="custom-control-input">
                            
                            <label class="custom-control-label" for="ups">UPS</label>
                        </div>
                        <div class="custom-control custom-radio">
                             <input <?= $user['role'] == 't1' ? 'checked' : ''; ?> <?= set_radio('role', 't1'); ?> value="t1" type="radio" id="t1" name="role" class="custom-control-input">
                            
                            <label class="custom-control-label" for="t1">T1</label>
                        </div>
                        <div class="custom-control custom-radio">
                             <input <?= $user['role'] == 't2' ? 'checked' : ''; ?> <?= set_radio('role', 't2'); ?> value="t2" type="radio" id="t2" name="role" class="custom-control-input">
                           
                            <label class="custom-control-label" for="t2">T2</label>
                        </div>
                        <div class="custom-control custom-radio">
                             <input <?= $user['role'] == 't3' ? 'checked' : ''; ?> <?= set_radio('role', 't3'); ?> value="t3" type="radio" id="t3" name="role" class="custom-control-input">
                            
                            <label class="custom-control-label" for="t3">T3</label>
                        </div>
                        <div class="custom-control custom-radio">
                             <input <?= $user['role'] == 'ntes' ? 'checked' : ''; ?> <?= set_radio('role', 'ntes'); ?> value="ntes" type="radio" id="ntes" name="role" class="custom-control-input">
